 ...
 * @return string
 */
function imageToBase64($imageFile, $prefix = false)
{
    $imageBase64 = '';
    if (file_exists($imageFile)) {
        ...
        if ($fp) {
            ...
            switch ($imageInfo[2]) {
                case 1:$imageType = 'gif';
                    break;
                case 2:$imageType = 'jpg';
                    break;
                case 3:$imageType = 'png';
                    break;
            }
            // 是否需要前缀编码
            if ($prefix) {
                $imageBase64 = 'data:image/' . $imageType . ';base64,' . $fileContent;
            } else {
